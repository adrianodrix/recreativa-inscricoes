    ...
    <article className={`rc-card ${styles.status}`}>
      ...
      <ul className="rc-card__meta">
        ...
        <li>
          ...
          {evento.total_inscritos} de {evento.limite_inscritos} inscritos
        </li>
      </ul>
      {pode(perfil, "mudar_status") && (
        <footer className="rc-card__footer">
          <span className={styles.statusLinha}>Chave do organizador: {evento.aberto_manual ? "liberada" : "encerrada"}</span>
